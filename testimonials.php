...
<head>
    ...
    <title>How it Works | Testimonials</title>
                ...
                <div class="container">
                    <div class="banner-content text-center" style="padding-top:270px;padding-bottom: 100px">
                        <div class="heading" data-animate="fadeInDown">
                            <h1 class="mb-0 text-gray"> Client's <span style="color: orange">Testimonials</span>  </h1></div>
                            <br/><br/>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <div class="sec-heading center">
                                 <p style="font-size: 23px;">More than 1000 People have enjoyed our Services, and now you can have a glimpse of what they say about us </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div style="background-color: #fff;padding:20px;">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <img src="coming_soon.gif" style="width: 100%">
                                    </div>
                                </div>
                            </div>
                        </div>
