<?php session_start();
    ...
    $lata = get_data_id_data("faq", "id", $_REQUEST['id']);
?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title>Edit FAQ | Dog Keeper</title>
                            ...
                            <div class="d-flex two-column mb-13 mx-n3">
                                <div class="page-left mb-6 px-3">
                                    ...
                                    <div style="padding: 20px;" class="px-3">
                                           <form action="edit_faq_handle.php" method="POST">
                                               <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                                   <h5>Edit FAQ  </h5><hr/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required="" value="<?php echo $lata['question'];  ?>" name="question" placeholder="Enter Question" class="form-control">
                                                    </div>

                                                    <div class="form-group">
                                                        <label style="font-weight: bold;">Enter Answer</label>
                                                        <textarea type="text" required=""   name="answer" rows="6" placeholder="Enter Answer" class="form-control"><?php echo $lata['answer'];  ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="id" value="<?php echo $lata['id'];  ?>">

                                                    <div class="form-group">
                                                       <button type="submit" class="btn btn-primary">Update this FAQ</button>
                                                    </div>
                                               </div>
                                           </form>
                                       </div>
