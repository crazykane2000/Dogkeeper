...
<body>
    ...
    <div class="page-content-wrapper d-flex flex-column" style="margin: 20px">
        <?php see_status($_REQUEST); ?>
            ...
            <div class="tabs">
                <ul class="nav nav-pills tab-style-01 font-size-lg" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="true">All Listings <?php echo count_tem_in_table("my_stuff"); ?> </a></li>
                    <li class="nav-item"> <a class="nav-link" id="active-tab" data-toggle="tab" href="#active" role="tab" aria-controls="active" aria-selected="false">Active Listings <?php echo get_count_items("my_stuff", "status", 'Active'); ?> </a></li>
            ...
            <div class="tab-content"  style="min-height: 700px">
                ...
                <div class="tab-pane fade" id="active" role="tabpanel" aria-labelledby="active-tab">
                    <div class="store-listing-style-04">
                        <?php 
                            try {
                                $stmt = $pdo->prepare('SELECT * FROM `my_stuff` WHERE `status`="Active"   ORDER BY date DESC');
        ...
        <div class="mt-5"> © 2020 DogKeeper. All Rights Reserved.</div>
    </div>
</div>
                </div>
            </div>
