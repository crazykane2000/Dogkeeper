...
<head>
    ...
    <title>My Events | Dog Keeper</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-7">
                                        <div class="page-content" style="padding: 20px;">
                                            <h4 style="color: #fb484e;text-transform: capitalize;">List of Events Listed By Me </h4>
                                           <hr/>
                                           <div style="padding: 15px;">
                                               <div class="row">
                                                <?php $dara = get_data_col("my_community", "uploaded_by_id", $pdo_auth['id']);
                                               // print_r($dara);
                                                foreach ($dara as $key => $value) {
                                                    echo '<div class="col-lg-12"><div style="padding: 10px 0px;"></div>
                                                               <a href="event_details.php?81f890e3c2d532abf67f3151939c52cd='.$value['id'].'" class="font-size-lg font-weight-semibold text-dark d-inline-block mb-2 lh-1" style=""><span class="letter-spacing-25" style="">'.$value['title'].' <span style="font-size:12px;"> (Event)</span></span> </a>
