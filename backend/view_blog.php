...
<head>
    ...
    <title>View Blog Data | Dog Keeper</title>
                                                  ...
                                                  try {
                                                    ...
                                                    foreach($user as $key=>$value){                                 
                                                      echo '<tr>
                                                            ...
                                                            <td>'.substr(strip_tags($value['desc']), 0,50).'...</td>    
                                                            <td><img src="blogs/thumb/'.$value['file'].'" style="width:50px;" /></td>      
                                                            <th><a href="delete_blog.php?id='.$value['id'].'" onclick="return confirm(\' Are You Sure You need to Delete this? \');"><button class="btn btn-danger btn-sm">Delete</button></a>  
                                                                <a href="edit_blog.php?id='.$value['id'].'" ><button class="btn btn-primary btn-sm">Edit</button></a>  
                                                            </th>                        
                                                        </tr>';
                                                        $i++;
                                                    }           
