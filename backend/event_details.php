<?php session_start();
    ...
    $fata = get_data_id_data("my_community", "id", $_REQUEST['81f890e3c2d532abf67f3151939c52cd']);
    //print_r($fata);
     ?>
...
<head>
    ...
    <title><?php echo $fata['title']; ?> | Dog Keeper</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="page-content" style="padding: 20px;">
                                            <h4 style="color: #fb484e;text-transform: capitalize;"><?php echo $fata['title']; ?>   </h4>
                                           
                                            <ul class="list-inline store-meta d-flex flex-wrap align-items-center">
                                               
                                                <li class="list-inline-item">
                                                <a target="_blank" href="https://maps.google.it/maps?q=<?php echo urlencode($fata['location']);  ?>" class=" text-link text-decoration-none d-flex align-items-center">
                                                ...
                                                <span><?php echo $fata['event_date'];  ?></span>
                                                </li>
                                            </ul>
                                            <hr/>
                                                ...
                                                <div class="card-body px-0 py-2">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item bg-transparent d-flex text-dark px-0">
                                                            ...
                                                            <span class="card-text"> Location : <a href="location_ads.php?81f890e3c2d532abf67f3151939c52cd=<?php echo $fata['id'];  ?>" class=" text-link"><?php echo $fata['address'];  ?></a></span>
                                                        </li>
                                                        <li class="list-group-item bg-transparent d-flex text-dark px-0">
