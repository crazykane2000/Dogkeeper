...
<head>
    ...
    <title>Add Dog Here | Dog Keeper</title>
                            ...
                            <div class="d-flex two-column mb-13 mx-n3">
                                <div class="page-left mb-6 px-3">
                                    ...
                                    <div style="padding: 20px;" class="px-3">
                                           ...
                                           <form action="add_dog_handle.php" method="POST">
                                               <div style="padding: 40px;background-color: #fff;width:100%;min-height: 600px">
                                                   <h4 style="color: #fb484e">Add Dog Here  </h4><hr/>
                                                     ...
                                                     <div class="row" style="color: #222;">
                                                        ...
                                                        <div class="col-lg-3">
                                                          <div class="form-group">
                                                              ...
                                                              <input type="text" required="" name="dog_name" rows="6" placeholder="Enter Dog Name" class="form-control">
                                                          </div>
                                                          <div style="padding: 3px;"></div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-12 col-lg-12">
                                                            ...
                                                            <div style="padding: 10px"></div>
                                                             ...
                                                             <input type="hidden" name="uniq_id" id="uniq_id" value="<?php echo $uniq_id; ?>">
                                                        </div>
                                                    </div>
