...
<head>
    ...
    <title>View Contact Data | Dog Keeper</title>
                                        ...
                                        <?php see_status($_REQUEST); ?>
                                           <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                                ...
                                                <table  style="color: #333;font-size: 13px;" class="table table-striped table-hover">
                                                  ...
                                                  <?php 
                                                  try {
                                                        $stmt = $pdo->prepare('SELECT * FROM `contact`   ORDER BY date DESC');
                                                    ...
                                                    if ($value['name']=="") {
                                                      ...
                                                      if (preg_match("/\bhttp\b/",$value['message'])) {
                                                        continue;
                                                      }                       
                                                      echo '<tr>
                                                            <td>'.$i.'</td>
                                                            ...
                                                            <td>'.substr(strip_tags(htmlspecialchars_decode($value['message'])), 0,100).'</td> 
                                                            <td>'.$value['date'].'</td>      
