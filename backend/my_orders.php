...
<head>
    ...
    <title>My Orders | Dog Keeper</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="page-content" style="padding: 20px;">
                                            <h4 style="color: #fb484e;text-transform: capitalize;">My Orders </h4>
                                           <hr/>
                                                        ...
                                                        <table class="table listing-table listing-table-job table-hover bg-white">
                                                            <tbody>                                                                
                                                                 <?php
                                                                    ...
                                                                    try {
                                                                          $stmt = $pdo->prepare('SELECT * FROM `message` WHERE `sender_id`="'.$pdo_auth['id'].'" AND  `stripeToken`!="" ORDER BY date DESC ');
                                                                      ...
                                                                      $rada = $stmt->fetchAll();
                                                                        ...
                                                                        echo '<tr>
                                                                                ...
                                                                                <td><span
                                                                                        class="text-secondary">'.$order['location'].'</span>
                                                                                </td>
                                                                                <td><span
                                                                                        class="text-secondary badge badge-success">'.$order['price'].' USD Paid</span>
                                                                                </td>
                                                                                <td>
                                                                                    <a href="view_order_details.php?Order_id_data_middle_is_teh_kanoon='.$value['id'].'" class="btn btn-primary btn-sm">View Details</a>
                                                                                </td>
                                                                            </tr>';
                                                                    }
                                                                 ?>  
