...
<head>
    ...
    <title>Add Blog Category | Dog Keeper</title>
                                    ...
                                    <div style="padding: 20px;" class="px-3">
                                           <form action="add_blog_category_handle.php" method="POST">
                                               <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                                   <h5>Add Blog Category  </h5><hr/>
                                                    <div style="padding: 10px;"></div>

                                                    <div class="form-group">
                                                        <label style="font-weight: bold;">Enter Blog Category Name</label>
                                                        <input type="text" required="" name="blog_category" placeholder="Enter Blog Category Name" class="form-control">
                                                    </div>
