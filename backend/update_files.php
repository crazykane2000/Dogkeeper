...
<head>
    ...
    <title>View Image | Dog Keeper</title>
                                    ...
                                    <div style="padding: 20px;" class="px-3">
                                        <?php see_status($_REQUEST); ?>
                                           <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                               <div class="row">
                                                   <div class="col-sm-8">
                                                    <?php $fad = get_data_id_data("my_stuff", "uniq_id", $_REQUEST['uniq_id']); ?>
                                                        <h5>Update images <a href="update_listing.php?id=<?php echo $fad['id']; ?>" class="btn btn-sm btn-primary">Back to Product</a> </h5><hr/>
