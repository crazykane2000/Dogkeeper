                                        ...
                                        <?php see_status($_REQUEST); ?>
                                           <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                                ...
                                                <table  style="color: #333;font-size: 13px;" class="table table-striped table-hover">
                                                  ...
                                                  <?php 
                                                  try {
                                                        $stmt = $pdo->prepare('SELECT * FROM `users` WHERE `user_type`= "Dog Owner" ORDER BY date DESC');
                                                    ...
                                                    if ($value['email']=="admin@dogkeeper.com") {
                                                      ...
                                                      echo '<tr>
                                                           ...
                                                           <td>'.$value['date'].'</td>      
                                                            <th><a href="delete_users.php?id='.$value['id'].'" onclick="return confirm(\' Are You Sure You need to Delete this? \');"><button class="btn btn-danger btn-sm">Delete</button></a>  </th>                        
                                                        </tr>';
                                                        $i++;
                                                    }           
                                                  ?>                    
