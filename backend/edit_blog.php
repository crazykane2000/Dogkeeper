...
<head>
    ...
    <title>Edit Blog | Dog Keeper</title>
                            ...
                            <div class="d-flex two-column mb-13 mx-n3">
                                <div class="page-left mb-6 px-3">
                                    ...
                                    <div style="padding: 20px;" class="px-3">
                                           <form action="edit_blog_handle.php" method="POST" enctype="multipart/form-data">
                                               <div style="padding: 20px;background-color: #fff;width:100%;min-height: 600px">
                                                   <h5>Edit Blog  </h5><hr/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required="" value="<?php echo $lata['title']; ?>" name="blog_title" placeholder="Enter Title" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" required="" id="editor1" name="blog_desc"  placeholder="Enter Blog Descriptions" class="form-control"><?php echo $lata['desc']; ?></textarea>
                                                    </div>
